      ...
      <div className="w-full max-w-sm">
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 flex flex-col items-center gap-6"
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-slate-500 mt-1">Lead generation dashboard</p>
          </div>
          <button
            onClick={signInWithGoogle}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white text-gray-800 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors"
          >
